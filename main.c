 ...
 do{
  ...
  switch(choice)
  {
   case 1:
   {
    ...
    printf("Enter\n1 - Sandisk 16 GB - Rs.450\n2 - Logitech Mouse- Rs.700\n3 - Pendrive 16 GB - Rs.900\nAny other number to exit\n");
    ...
    switch(accessoriesChoice)
    {
     ...
     {
      int num;
      printf("You chose Sandisk 16GB with Rs.450.Are you sure to buy.If 'Yes' Enter 1 else any number\n");
      scanf("%d",&num);
      if(num==1)
      {
       a[0]++;
     ...
     {
      int num;
      printf("You chose Logitech Mouse with Rs.700.Are you sure to buy.If 'Yes' Enter 1 else any number\n");
      scanf("%d",&num);
      if(num==1)
      {
       a[1]++;
     ...
     {
      int num;
      printf("You chose Pendrive 16GB with Rs.700.Are you sure to buy.If 'Yes' Enter 1 else any number\n");
      scanf("%d",&num);
      if(num==1)
      {
       a[2]++;
